...
import Emperium from "../img/img1.png"
import Chef from '../img/img2.png'
					...
					<div id="agualuz" className="modal-card">
						...
						<div className="modal-info">
							...
							<div className="modal-description">
								...
								<ul>
									<li>
										Prototype de site de Restaurent, Developper avec html,scss,boostrap
									</li>
					...
					<div id="todolist" className="modal-card">
						...
						<div className="modal-info">
							...
							<div className="modal-description">
								<ul>
									<li>
										une simple todolist, developper avec HTML5, CSS3, Bootstrap
									    and ReactJS.
									</li>
